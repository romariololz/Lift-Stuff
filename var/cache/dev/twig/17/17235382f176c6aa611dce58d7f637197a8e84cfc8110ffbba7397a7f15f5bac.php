...
class __TwigTemplate_0cc5a6b6bfa799388010e5f7f05cee4928c96c348bfd4ee8fb99290ab89d502d extends Twig_Template
{
    private $source;
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        <div class=\"text-exception\">
            ...
            <h1>";
        // line 14
        echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 14, $this->source); })()), "message", array()), "html", null, true)));
        echo "</h1>

            <div>
                <strong>";
        // line 17
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new Twig_Error_Runtime('Variable "status_code" does not exist.', 17, $this->source); })()), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new Twig_Error_Runtime('Variable "status_text" does not exist.', 17, $this->source); })()), "html", null, true);
        echo " - ";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 17, $this->source); })()), "class", array()));
        echo "
            </div>

            ";
        // line 20
        $context["previous_count"] = twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 20, $this->source); })()), "allPrevious", array()));
        // line 21
        echo "            ";
        if ((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 21, $this->source); })())) {
            // line 22
            echo "                <div class=\"linked\"><span><strong>";
            echo twig_escape_filter($this->env, (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 22, $this->source); })()), "html", null, true);
            echo "</strong> linked Exception";
            echo ((((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 22, $this->source); })()) > 1)) ? ("s") : (""));
            echo ":</span>
                    <ul>
                        ";
            // line 24
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 24, $this->source); })()), "allPrevious", array()));
...
";
        // line 40
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 40, $this->source); })()), "toarray", array()));
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 41
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 41)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 41, $this->source); })())));
        }
        $_parent = $context['_parent'];
...
";
        // line 44
        if ((isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 44, $this->source); })())) {
            // line 45
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 57
            if (twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 57, $this->source); })()), "counterrors", array())) {
                // line 58
                echo "                <div class=\"error-count\">
                    <span>
                        ";
                // line 60
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 60, $this->source); })()), "counterrors", array()), "html", null, true);
                echo " error";
                echo (((twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 60, $this->source); })()), "counterrors", array()) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 67
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 67)->display(array("logs" => twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 67, $this->source); })()), "logs", array())));
            // line 68
            echo "        </div>
    </div>
";
...
";
        // line 72
        if ((isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 72, $this->source); })())) {
            // line 73
            echo "    <div class=\"block\">
        ";
            // line 74
        ...
        <div id=\"output-content\" style=\"display: none\">
            ";
            // line 85
            echo twig_escape_filter($this->env, (isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 85, $this->source); })()), "html", null, true);
            echo "
        </div>
...
";
        // line 92
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 92)->display(array("exception" => (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 92, $this->source); })())));
        // line 93
        echo "
...
";
    ...
    {
        return array (  209 => 93,  207 => 92,  204 => 91,  195 => 85,  191 => 83,  181 => 75,  179 => 74,  176 => 73,  174 => 72,  171 => 71,  166 => 68,  164 => 67,  159 => 64,  150 => 60,  146 => 58,  144 => 57,  141 => 56,  131 => 48,  129 => 47,  125 => 45,  123 => 44,  120 => 43,  113 => 41,  109 => 40,  99 => 32,  94 => 29,  77 => 26,  74 => 25,  70 => 24,  62 => 22,  59 => 21,  57 => 20,  47 => 17,  41 => 14,  26 => 1,);
    }
...
//]]></script>
", "@Twig/Exception/exception.html.twig", "/home/romariololz/www-dev/LAB/code-javascript/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
