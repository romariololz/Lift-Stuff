...
class __TwigTemplate_73f8d2c8ab985a184892980f7b6f11a5070772f6b43fe75aec1de1376b79c4d2 extends Twig_Template
{
    private $source;
    ...
    <div id=\"content\" class=\"container\">
        ...
        if ((isset($context["templates"]) || array_key_exists("templates", $context))) {
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["templates"]) || array_key_exists("templates", $context) ? $context["templates"] : (function () { throw new Twig_Error_Runtime('Variable "templates" does not exist.', 114, $this->source); })()));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                if (                $this->loadTemplate($context["template"], "@WebProfiler/Profiler/layout.html.twig", 116)->hasBlock("menu", $context)) {
                    // line 117
                    $__internal_7cd7461123377b8c9c1b6a01f46c7bbd94bd12e59266005df5e93029ddbc0ec5 = array("collector" => twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new Twig_Error_Runtime('Variable "profile" does not exist.', 117, $this->source); })()), "getcollector", array(0 => $context["name"]), "method"), "profiler_markup_version" => (isset($context["profiler_markup_version"]) || array_key_exists("profiler_markup_version", $context) ? $context["profiler_markup_version"] : (function () { throw new Twig_Error_Runtime('Variable "profiler_markup_version" does not exist.', 117, $this->source); })()));
                    if (!is_array($__internal_7cd7461123377b8c9c1b6a01f46c7bbd94bd12e59266005df5e93029ddbc0ec5)) {
                        throw new Twig_Error_Runtime('Variables passed to the "with" tag must be a hash.', 117, $this->source);
                    }
                    $context['_parent'] = $context;
                ...
                // line 122
                echo "                            ";
                if ( !twig_test_empty((isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new Twig_Error_Runtime('Variable "menu" does not exist.', 122, $this->source); })()))) {
                    // line 123
                    echo "                                <li class=\"";
                    echo twig_escape_filter($this->env, $context["name"], "html", null, true);
                    echo " ";
                    echo ((($context["name"] == (isset($context["panel"]) || array_key_exists("panel", $context) ? $context["panel"] : (function () { throw new Twig_Error_Runtime('Variable "panel" does not exist.', 123, $this->source); })()))) ? ("selected") : (""));
                    echo "\">
                                    <a href=\"";
                    // line 124
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", array("token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 124, $this->source); })()), "panel" => $context["name"])), "html", null, true);
                    echo "\">";
                    echo (isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new Twig_Error_Runtime('Variable "menu" does not exist.', 124, $this->source); })());
                    echo "</a>
                                </li>
                            ";
                }
...
";
    ...
    public function block_summary($context, array $blocks = array())
    {
        ...
        if ((isset($context["profile"]) || array_key_exists("profile", $context))) {
            ...
            // line 23
            echo "                        ";
            if (((isset($context["request_collector"]) || array_key_exists("request_collector", $context)) && twig_get_attribute($this->env, $this->source, (isset($context["request_collector"]) || array_key_exists("request_collector", $context) ? $context["request_collector"] : (function () { throw new Twig_Error_Runtime('Variable "request_collector" does not exist.', 23, $this->source); })()), "redirect", array()))) {
                // line 24
            ...
            echo "</dd>
                            ...
                            <dd>";
            // line 71
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new Twig_Error_Runtime('Variable "profile" does not exist.', 71, $this->source); })()), "ip", array()), "html", null, true);
            echo "</dd>

                            <dt>Profiled on</dt>
                            <dd>";
            // line 74
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new Twig_Error_Runtime('Variable "profile" does not exist.', 74, $this->source); })()), "time", array()), "r"), "html", null, true);
            echo "</dd>

                            <dt>Token</dt>
                            <dd>";
            // line 77
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new Twig_Error_Runtime('Variable "profile" does not exist.', 77, $this->source); })()), "token", array()), "html", null, true);
            echo "</dd>
                        </dl>
                    </div>
                </div>
    ...
    {
        return array (  383 => 90,  376 => 82,  368 => 77,  362 => 74,  356 => 71,  350 => 68,  344 => 65,  339 => 62,  330 => 58,  326 => 57,  324 => 56,  322 => 55,  314 => 54,  312 => 53,  307 => 50,  305 => 49,  303 => 48,  301 => 47,  298 => 46,  289 => 42,  286 => 40,  281 => 38,  279 => 37,  271 => 36,  269 => 35,  267 => 34,  263 => 33,  256 => 29,  252 => 27,  250 => 26,  248 => 25,  246 => 24,  243 => 23,  241 => 22,  237 => 20,  231 => 18,  223 => 16,  221 => 15,  215 => 12,  212 => 11,  209 => 10,  206 => 9,  203 => 8,  197 => 7,  187 => 130,  183 => 128,  169 => 127,  161 => 124,  154 => 123,  151 => 122,  146 => 118,  139 => 117,  137 => 116,  134 => 115,  117 => 114,  114 => 113,  112 => 112,  105 => 108,  99 => 105,  93 => 104,  88 => 102,  84 => 101,  78 => 98,  69 => 91,  67 => 90,  63 => 89,  55 => 83,  53 => 7,  46 => 4,  40 => 3,  15 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "/home/romariololz/www-dev/LAB/code-javascript/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Profiler/layout.html.twig");
    }
}
